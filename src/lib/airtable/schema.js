...
export const Columns = {
  ...
  Payment: {
    ...
    orderId: { name: `Order ID`, type: `text` },
    payerId: { name: `Payer ID`, type: `text` },
    currencyCode: { name: `Currency Code`, type: `text` },
    address: { name: `Address`, type: `text` },
    payerFullName: { name: `Payer Full Name`, type: `text` },
    intent: { name: `Intent`, type: `text` },
    paymentCreateTime: { name: `Payment Create Time`, type: `text` },
    paymentUpdateTime: { name: `Payment Update Time`, type: `text` },
